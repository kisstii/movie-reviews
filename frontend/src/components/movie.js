...
function Movie({ movie_title, movie_id, backdrop_path, poster_path, setShowReviewForm, setCurrentMovieId, showReviewForm, setCurrentTitle, setShowAllReviews, showAllReviews }) {
  return (
